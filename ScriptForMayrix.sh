...
FILES="main_matrix.cpp matrix_print.cpp matrix_sum.cpp write_matrix_from_file.cpp matrix_ladder.cpp crooked_matrix.cpp crooked_matrix_2.cpp crooked_matrix_3.cpp"
OUT_PROG="matrix.exe"
